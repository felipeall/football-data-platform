"""Create FBRef MatchesReports model
...
def upgrade() -> None:
    ...
    op.execute(sa.text(create_trigger.format(schema="fbref", table="matches_reports")))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("matches_reports", schema="fbref")
    # ### end Alembic commands ###
